...
const services = [
  ...
  { icon: Zap, title: 'AC & Appliances', desc: 'Home Comfort Systems', keywords: 'Cooling, Home', img: 'https://images.unsplash.com/photo-1584622650111-993a426fbf0a?q=80&w=2070&auto=format&fit=crop' },
  ...
  { icon: Package, title: 'PC & Gaming', desc: 'Custom Gaming Rigs', keywords: 'Gaming, PCs', img: 'https://images.unsplash.com/photo-1629429408209-1f912961dbd8?q=80&w=2070&auto=format&fit=crop' },
  { icon: Users, title: 'Coaching Classes', desc: 'Professional Education', keywords: 'Education, Skills', img: 'https://images.unsplash.com/photo-1524178232363-1fb2b075b655?q=80&w=2070&auto=format&fit=crop' },
